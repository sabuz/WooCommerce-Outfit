...
function newOutfitShortcode($atts, $content = null) {
...
add_shortcode('new-outfit', 'newOutfitShortcode');


// Style Gallery Shortcode
function styleGalleryShortcode() {
	global $post;
...
add_shortcode('style-gallery', 'styleGalleryShortcode');


// All Outfit Shortcode
function allOutfitShortcode() {
...
add_shortcode('all-outfit', 'allOutfitShortcode');
?>